<template>
  <div class="insert-link">
    <div class="insert-link-box">
      ...
      <p>Insertar el link</p>
      <input type="text" name="text" placeholder="Texto del enlace" v-model='text' v-on:keyup.enter='conformClick'>
      <input type="text" name="link" placeholder="dirección de enlace" v-model='link'>
      <button @click='conformClick'>Confirmar</button>
    </div>
  </div>
</template>
