...
export default {
    ...
    data () {
        ...
        return {
            ...
            hasreadCount: 0,
            recyclebinCount: 0,
            noDataText: 'Aún no hay mensajes sin leer',
            mes: {
                title: '',
                time: '',
                content: ''
    ...
    methods: {
        ...
        setCurrentMesType (type) {
            ...
            if (type === 'unread') {
                this.noDataText = 'Aún no hay mensajes sin leer';
                this.currentMesList = this.unreadMesList;
            } else if (type === 'hasread') {
                this.noDataText = 'Aún no se han leído mensajes';
                this.currentMesList = this.hasreadMesList;
            } else {
                this.noDataText = 'No hay mensaje en la papelera de reciclaje';
        ...
        getContent (index) {
            ...
            switch (this.currentMessageType + index) {
                case 'unread0': mesContent = 'Este es el contenido relevante de "Bienvenido a iniciar sesión en el sistema de gestión en segundo plano iView-admin y conocer su uso" en el que hizo clic.'; break;
                case 'unread1': mesContent = 'Este es el contenido relevante de "Uso de iView-admin y la biblioteca de componentes iView-ui para construir rápidamente su sistema de fondo" en el que hizo clic.'; break;
                case 'unread2': mesContent = 'Este es el contenido relevante de "Si te gusta iView-admin, bienvenido a la página de inicio de github para dar una estrella".'; break;
                case 'hasread0': mesContent = 'Esto es lo que hizo clic en "Este es un mensaje que ya ha leído".'; break;
                default: mesContent = 'Esto es lo que hizo clic en "Este es un mensaje eliminado".'; break;
            }
    ...
    mounted () {
        ...
        this.hasreadMesList = [
            {
                title: 'Este es un mensaje que ya has leído.',
                time: 1507330106000
            }
        ];
        this.recyclebinList = [
            {
                title: 'Este es un mensaje eliminado',
                time: 1506390106000
            }
        ];
