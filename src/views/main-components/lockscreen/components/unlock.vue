...
<template>
    <transition name="show-unlock">
        <div class="unlock-body-con" v-if="showUnlock" @keydown.enter="handleUnlock">
            ...
            <div class="unlock-locking-tip-con">bloqueado</div>
        </div>
    </transition>
</template>
    ...
    methods: {
        ...
        handleUnlock () {
            if (this.validator()) {
                ...
                this.$Message.error(
                    'Contraseña incorrecta, vuelva a ingresar. Si olvida la contraseña, borre el caché del navegador e inicie sesión nuevamente. No hay verificación de back-end aquí');
            }
        },
        unlockMousedown () {
