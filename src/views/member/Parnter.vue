    ...
    export default {
        data () {
            return {
                ...
                ruleInline: {
                    coinId: [
                        { required: true, message: 'coinId', trigger: 'blur' }
                    ],
                    amount: [
                        { required: true, message: 'amount', trigger: 'blur' }
                    ],
                    memberId:[
                        { required: true, message: 'memberId', trigger: 'blur' }
                    ]
                }
            }
        },
