...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        ...
        <div class="main-header-con" :style="{paddingLeft: shrink?'120px':'170px'}">
                        ...
                        <Row type="flex" justify="end" align="middle" class="user-dropdown-innercon">
                            <Dropdown transfer trigger="click" @on-click="handleClickUserDropdown">
                                ...
                                <DropdownMenu slot="list">
                                  <DropdownItem name="ownSpace">Centro personal</DropdownItem>
                                  <DropdownItem name="loginout" divided class="resetexit">Logout</DropdownItem>
                                </DropdownMenu>
                            </Dropdown>
            ...
            <div style="background-image: linear-gradient( 135deg, #F0A70A 10%, #0D25B9 100%);text-align: center;height:30px;line-height:30px;letter-spacing: 1px;color:#FFF;"></div>
            <div class="tags-con">
