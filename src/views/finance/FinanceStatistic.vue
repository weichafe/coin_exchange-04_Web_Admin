		...
		<Row style="padding-top: 40px">
				...
				<div class="card">
					<div class="title">
						<p>
							...
							<span class="detail" @click="skipRouter(totalVolume)">Detalles</span>
						</p>
					</div>
					<div class="body">
						<Row>
							<Col span="7" offset="1">divisa</Col>
							<Col span="7" offset="1">volumen</Col>
							<Col span="7" offset="1">cantidad de transacción</Col>
						</Row>
			...
			<Col span="10" offset="2">
				<div class="card">
					...
					<div class="body">
						<Row>
							<Col span="12">divisa</Col>
							<Col span="12">tasa de tramitación</Col>
						</Row>
					...
					<div class="title">
						<p>
							<span :class="{ active: totalCoin.tardeType.active === index }"
										...
										:key="index">{{ trade.type }}</span>
							<span class="detail" @click="skipRouter(totalCoin)">Detalles</span>
						</p>
					</div>
					<div class="body">
						<Row>
							<Col span="12">divisa</Col>
							<Col span="12">Importe total del depósito</Col>
						</Row>
	...
	data() {
		return {
			totalVolume: {
				...
				tabelArr: [],
				timeRange: { active: 0, time: ['el dia de ayer', 'tres días', 'una semana'] },
				tardeType: { active: 0, type: [
					{ status: ['OTC_NUM', 'OTC_MONEY'], type: 'Transacción en moneda fiduciaria', router: '/finance/otcdetail' },
					{ status: ['EXCHANGE_BASE', 'EXCHANGE_COIN'], type: 'comercio de divisas', router: '/' }
				]}
			},
			totalFee: {
				type: 'fee',
				...
				timeRange: { active: 0, time: ['el dia de ayer', 'tres días', 'una semana'] },
				tardeType: { active: 0, type: [
					{ status: 0, type: 'Transacción en moneda fiduciaria', router: '/finance/otcdetail'},
					{ status: 2, type: 'comercio de divisas', router: '/'},
					{ status: 6, type: 'Retirar', router: '/finance/withdrawdetail'}
				]}
			},
			totalCoin: {
				type: 'coin',
				...
				timeRange: { active: 0, time: ['el dia de ayer', 'tres días', 'una semana'] },
				tardeType: { active: 0, type: [
					{ status: 5, type: 'depósito', router: '/finance/changecoindetail' },
					{ status: 6, type: 'Retirar', router: '/finance/withdrawdetail' }
				]}
			},
		}
