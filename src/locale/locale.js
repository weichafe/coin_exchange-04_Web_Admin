export default {
    ...
    'es-ES': {
        home: 'home',
        switchLangTitle: 'Cambiar idioma',
        international: 'Cambiar idioma',
        tip: 'Nota: iview-admin solo para demostrar cómo lograr el cambio de varios idiomas, por lo que solo la página actual para hacer la traducción.',
        iviewComponentTitle: 'El efecto en la iview',
        intro: 'iview actualmente admite 15 idiomas, siempre que vea el componente iview donde el texto se basará en su tipo de idioma y configurará automáticamente el idioma correspondiente.',
        placeholderText: 'por favor ingrese texto...',
        placeholderDate: 'Seleccione fecha',
        name: 'nombre',
        company: 'empresa',
        btnText: 'Haga clic para mostrar modal',
        modalText: 'Aquí puede ver el cuadro modal iview por defecto a los botones Aceptar y Cancelar que cambiarán el idioma',
        poptip: 'punta pop internacional',
        showPoptipText: 'Haga clic para mostrar la ventana emergente'
    }
};
